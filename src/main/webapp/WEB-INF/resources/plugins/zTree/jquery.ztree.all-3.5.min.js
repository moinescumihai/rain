...
(function (q) {
    var G, H, I, J, K, L, r = {}, u = {}, v = {}, M = {
        ...
        if (j.eqs(b.type, "mousedown"))l = "mousedown"; else if (j.eqs(b.type, "mouseup"))l = "mouseup"; else if (j.eqs(b.type, "contextmenu"))l = "contextmenu"; else if (j.eqs(b.type, "click"))if (j.eqs(a.tagName, "span") && a.getAttribute("treeNode" + e.id.SWITCH) !== null)d = j.getNodeMainDom(a).id, g = "switchNode"; else {
            if (k = j.getMDom(c, a, [{tagName: "a", attrName: "treeNode" + e.id.A}]))d = j.getNodeMainDom(k).id,
                g = "clickNode"
        } else if (j.eqs(b.type, "dblclick") && (l = "dblclick", k = j.getMDom(c, a, [{tagName: "a", attrName: "treeNode" + e.id.A}])))d = j.getNodeMainDom(k).id, g = "switchNode";
        if (l.length > 0 && d.length == 0 && (k = j.getMDom(c, a, [{tagName: "a", attrName: "treeNode" + e.id.A}])))d = j.getNodeMainDom(k).id;
        ...
        addNodeCache: function (b, a) {
            ...
            if (!a || !c)return [];
            for (var f = b.data.key.children, g = [], d = d.toLowerCase(), e = 0, i = a.length; e < i; e++)typeof a[e][c] ==
            "string" && a[e][c].toLowerCase().indexOf(d) > -1 && g.push(a[e]), g = g.concat(h.getNodesByParamFuzzy(b, a[e][f], c, d));
            return g
            ...
            for (var c = h.getRoot(b), d = 0, f = c.curSelectedList.length; d < f; d++)if (a === c.curSelectedList[d] || !h.getNodeCache(b,
                    c.curSelectedList[d].tId))c.curSelectedList.splice(d, 1), b.treeObj.trigger(e.event.UNSELECTED, [b.treeId, a]), d--, f--
            ...
            if (j.isArray(a))for (var f = 0, g = a.length; f < g; f++)d.push(a[f]), a[f][c] && (d = d.concat(h.transformToArrayFormat(b, a[f][c]))); else d.push(a), a[c] &&
        ...
        bindEvent: function (b) {
            for (var a = 0, c = w.length; a < c; a++)w[a].apply(this,
                arguments)
    ...
    var j = {
        ...
        addNodes: function (b, a, c, d) {
            ...
            for (f = 0, g = b.async.autoParam.length; a && f < g; f++) {
                var p = b.async.autoParam[f].split("="), n = p;
            ...
            if (b.callback.onNodeCreated ||
                b.view.addDiyDom)for (var a = h.getRoot(b); a.createdNodes.length > 0;) {
            ...
            b &&
            (h.initCache(b), h.initRoot(b), m.unbindTree(b), m.unbindEvent(b), b.treeObj.empty(), delete r[b.treeId])
            ...
            if (a) {
                ...
                if (a.open == c)j.apply(f, []); else {
                    ...
                    "" || !(a[l] && a[l].length > 0) ? (c.hide(), j.apply(f, [])) : c.slideUp(b.view.expandSpeed, f))) : j.apply(f, [])
                }
            } else j.apply(f, [])
            ...
            if (g)for (var k =
                0, m = g.length; k < m; k++)g[k] && i.expandCollapseSonNode(b, g[k], c, e);
            ...
            b.push("<span id='", c.tId, e.id.ICON, "' title='' treeNode", e.id.ICON, " class='", i.makeNodeIcoClass(a,
                c), "' style='", i.makeNodeIcoStyle(a, c), "'></span><span id='", c.tId, e.id.SPAN, "'>", d, "</span>")
            ...
            b.push("</a>")
        }, makeDOMNodeNameBefore: function (b,
                                            a, c) {
            ...
            return e.className.BUTTON +
                " " + e.className.LEVEL + b.level + " " + e.className.SWITCH + " "
            ...
            if (h.getNodeCache(b, a.tId)) {
                ...
                h.removeSelectedNode(b, a);
                for (var g = 0, j = f[d].length; g < j; g++)if (f[d][g].tId == a.tId) {
                    f[d].splice(g, 1);
                    break
                }
                i.setFirstNode(b, f);
                i.setLastNode(b, f);
                var p, g = f[d].length;
                if (!b.data.keep.parent && g == 0)f.isParent = !1, f.open = !1, g = k(f, e.id.UL, b), j = k(f, e.id.SWITCH, b), p = k(f, e.id.ICON, b), i.replaceSwitchClass(f, j, e.folder.DOCU), i.replaceIcoClass(f, p, e.folder.DOCU), g.css("display", "none"); else if (b.view.showLine && g > 0) {
                    var n = f[d][g - 1], g = k(n, e.id.UL, b), j = k(n, e.id.SWITCH, b);
                    p = k(n, e.id.ICON, b);
        ...
        replaceIcoClass: function (b, a, c) {
            ...
            if (a) {
                ...
                g.length ==
                0 ? d.removeClass(e.line.LINE) : d.addClass(g);
            ...
            c = {
                ...
                getNodes: function () {
                    ...
                    return !a || typeof a != "function" ?
                        b ? null : [] : h.getNodesByFilter(d, c ? c[d.data.key.children] : h.getNodes(d), a, b, e)
    ...
    var N = q.fn.zTree, k = j.$, e = N.consts
})(jQuery);
...
(function (m) {
    var p, q, r, o = {
        ...
        check: {enable: !1, autoCheckTrigger: !1, chkStyle: o.checkbox.STYLE, nocheckInherit: !1, chkDisabledInherit: !1, radioType: o.radio.TYPE_LEVEL, chkboxType: {Y: "ps", N: "ps"}},
