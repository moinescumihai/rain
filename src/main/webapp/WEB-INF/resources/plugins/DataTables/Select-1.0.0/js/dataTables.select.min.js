...
(function (j, u, i) {
    j = function (e, h) {
        ...
        function r(a, c, b, d, g) {
            ...
            }, !c.cells({selected: !0}).any() && !d ? (f = f(0, g.column), d = a(0, g.row)) : (f = f(d.column, g.column), d = a(d.row, g.row)), d = c.cells(d, f).flatten(), c.cells(g, {selected: !0}).any() ? c.cells(d).deselect() : c.cells(d).select()) : (a = b._select_lastCell ?
                ...
                if (!c._select_init) {
                    ...
                    b.on("preXhr.dt.dtSelect", function () {
                        var a = b.rows({selected: !0}).ids(!0).filter(function (b) {
                            ...
                            return c ? {row: c, column: a.column} : i
                        }).filter(function (b) {
                            return b !== i
                        });
        ...
        n("rows().select()", "row().select()", function (a) {
            ...
            this.iterator("row", function (b, a) {
                ...
                e(b.aoData[a].nTr).addClass("selected")
            });
        ...
        n("columns().select()", "column().select()", function (a) {
            ...
            this.iterator("column", function (b, a) {
                ...
                var c = (new h.Api(b)).column(a);
                e(c.header()).addClass("selected");
                e(c.footer()).addClass("selected");
                c.nodes().to$().addClass("selected")
            });
            this.iterator("table", function (b, a) {
                l(c, "select", ["column",
                    c[a]], !0)
        ...
        n("cells().select()", "cell().select()", function (a) {
            ...
            this.iterator("cell", function (b, a, c) {
                ...
                b._selected_cells[c] = !0;
                b.anCells && e(b.anCells[c]).addClass("selected")
            });
            this.iterator("table", function (b, a) {
        ...
        e.extend(h.ext.buttons, {
            selected: {
                text: p("selected", "Selected"), className: "buttons-selected", init: function (a) {
                    var c =
                        this;
                    a.on("select.dt.DT deselect.dt.DT", function () {
