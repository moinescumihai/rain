(function (g, f) {
    ...
    e.Client.prototype = {
        id: 0, ready: !1, movie: null, clipText: "", fileName: "", action: "copy", handCursorEnabled: !0, cssEffects: !0, handlers: null, sized: !1, glue: function (a, b) {
            ...
            if (navigator.userAgent.match(/MSIE/))var h = location.href.match(/^https/i) ? "https://" : "http://", d = d + ('<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="' + h + 'download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=10,0,0,0" width="' + a + '" height="' + b + '" id="' + this.movieId + '" align="middle"><param name="allowScriptAccess" value="always" /><param name="allowFullScreen" value="false" /><param name="movie" value="' +
        ...
        setHandCursor: function (a) {
            ...
            if (this.handlers[a])for (var c = 0, h = this.handlers[a].length; c < h; c++) {
                var e = this.handlers[a][c];
                if ("function" == typeof e)e(this, b); else if ("object" == typeof e && 2 == e.length)e[0][e[1]](this, b); else if ("string" == typeof e)window[e](this, b)
            }
        }
    };
    e.hasFlash = function () {
    ...
    window.ZeroClipboard_TableTools = e;
    var n = function (a, b) {
        b.attr("id");
        ...
        var d =
            b.match(/[\s\S]{1,8192}/g) || [];
        a.clearText();
        for (var c = 0, e = d.length; c < e; c++)a.appendText(d[c])
    }, o = function (a, b) {
        for (var d = b.newline ? b.newline : navigator.userAgent.match(/Windows/) ? "\r\n" : "\n", c = a.buttons.exportData(b.exportOptions), e = function (a) {
            return b.fieldBoundary + a.join(b.fieldBoundary + b.fieldSeparator + b.fieldBoundary) + b.fieldBoundary
        }, g = b.header ? e(c.header) + d : "", f = b.footer ? d + e(c.footer) : "", l = [], m = 0, p = c.body.length; m < p; m++)l.push(e(c.body[m]));
        return {str: g + l.join(d) + f, rows: l.length}
    }, i = {
        available: function () {
            return e.hasFlash()
        },
        init: function (a, b, d) {
            e.moviePath = f.Buttons.swfPath;
            var c = new e.Client;
            c.setHandCursor(!0);
            ...
            d._flash.destroy()
        }, fieldSeparator: ",", fieldBoundary: '"', exportOptions: {}, title: "*", extension: ".csv", header: !0, footer: !1
    };
    f.Buttons.swfPath = "//cdn.datatables.net/buttons/1.0.0/swf/flashExport.swf";
    f.Api.register("buttons.resize()", function () {
        g.each(e.clients, function (a,
                                    b) {
            void 0 !== b.domElement && b.domElement.parentNode && b.positionElement()
        })
    });
    f.ext.buttons.copyFlash = g.extend({}, i, {
        className: "buttons-copy buttons-flash", text: function (a) {
            return a.i18n("buttons.copy", "Copy")
        }, action: function (a, b, d, c) {
            c._fromFlash && (a = c._flash, c = o(b, c), a.setAction("copy"), k(a, c.str), b.buttons.info(b.i18n("buttons.copyTitle", "Copy to clipboard"), b.i18n("buttons.copyInfo", {
                _: "Copied %d rows to clipboard",
                1: "Copied 1 row to clipboard"
            }, c.rows), 3E3))
        }, fieldSeparator: "\t", fieldBoundary: ""
    });
    f.ext.buttons.csvFlash = g.extend({}, i, {
    ...
    f.ext.buttons.excelFlash = g.extend({}, i, {
        className: "buttons-excel buttons-flash", text: function (a) {
            ...
            var a = "", d = c._flash, b = b.buttons.exportData(c.exportOptions), e = function (a) {
                for (var b = [], c = 0, d = a.length; c < d; c++)b.push(g.isNumeric(a[c]) ?
                '<c t="n"><v>' + a[c] + "</v></c>" : '<c t="inlineStr"><is><t>' + a[c] + "</t></is></c>");
    ...
    f.ext.buttons.pdfFlash = g.extend({}, i, {
        className: "buttons-pdf buttons-flash", text: function (a) {
            return a.i18n("buttons.pdf", "PDF")
        }, action: function (a, b, d, c) {
            var a = c._flash, d = b.buttons.exportData(c.exportOptions), e =
                b.table().node().offsetWidth, f = b.columns(c.columns).indexes().map(function (a) {
