...
(function (r, n, m) {
    var p = function (e, i) {
        var p = 0, s = 0, k = i.ext.buttons, l = function (a, b) {
            !0 === b && (b = {});
            e.isArray(b) && (b = {buttons: b});
            this.c = e.extend(!0, {}, l.defaults, b);
            b.buttons && (this.c.buttons = b.buttons);
            this.s = {dt: new i.Api(a), buttons: [], subButtons: [], listenKeys: "", namespace: "dtb" + p++};
        ...
        e.extend(l.prototype, {
            action: function (a, b) {
                ...
                b = 0;
                for (a = c.length; b < a; b++)if (c.inst === this) {
                    c.splice(b, 1);
                    break
                }
                return this
            ...
            node: function (a) {
                ...
                if ("number" === typeof a || -1 === a.indexOf("-"))b = this.s.buttons[1 * a], b.conf.destroy && b.conf.destroy.call(c.button(a),
                    c, b, b.conf), b.node.remove(), this._removeKey(b.conf), this.s.buttons[1 * a] = null; else {
                    var d = a.split("-");
                ...
                for (var f = 0, g = a.length; f < g; f++) {
                    ...
                    if (h)if (e.isArray(h))this._buildButtons(h, b, c); else {
                        ...
                        if (j) {
                            var q = j.node;
                            b.append(j.inserter);
                            c === m ? (this.s.buttons.push({node: q, conf: h, inserter: j.inserter}), this.s.subButtons.push([])) : this.s.subButtons[c].push({node: q, conf: h, inserter: j.inserter});
                ...
                var c, d, f, g;
                f = this.s.buttons;
                var h = this.s.subButtons, j = function (c, d) {
                ...
                if (a.key) {
                    var b = e.isPlainObject(a.key) ?
                        a.key.key : a.key, a = this.s.listenKeys.split(""), b = e.inArray(b, a);
                    a.splice(b, 1);
        ...
        l.instanceSelector = function (a, b) {
            ...
            var c = [], d = e.map(b, function (a) {
                ...
                if (e.isArray(a))for (var h = 0, j = a.length; h < j; h++)f(a[h]); else"string" === typeof a ? -1 !== a.indexOf(",") ? f(a.split(",")) : (a = e.inArray(e.trim(a), d), -1 !== a && c.push(b[a].inst)) : "number" === typeof a && c.push(b[a].inst)
            };
            f(a);
            return c
        };
            ...
            for (var c = [], d = function (a, b) {
                ...
                e.each(b.s.subButtons, function (a, b) {
                    e.each(b, function (a, b) {
                        null !== b && i.push({node: b.node[0], name: b.name})
                    })
                });
                ...
                if (e.isArray(a) || a instanceof e) {
                    ...
                    f = 0;
                    for (g = i.length; f < g; f++)c.push({inst: b, idx: b.toIndex(i[f].node)})
                    ...
                    k = a.replace(":name", "");
                    f = 0;
                    for (g = i.length; f < g; f++)i[f].name === k && c.push({inst: b, idx: b.toIndex(i[f].node)})
        ...
        i.Api.register("buttons.exportData()", function (a) {
            if (this.context.length) {
                ...
                }).toArray() : null, g = b.rows(c.rows, c.modifier).indexes().map(function (a) {
        ...
        i.ext.feature.push({
            fnInit: function (a) {
                var a = new i.Api(a), b = a.init().buttons;
